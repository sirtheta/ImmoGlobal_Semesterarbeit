...
\begin{table}[H]
  ...
  \begin{tabulary}{1.0\textwidth}{LCL}
    ...
    1 = Unbedeutend\newline 2 = Gering \newline 3 = Moderat \newline 4 = Bedeutend \newline 5 = Katastrophal && 1 = unvorstellbar\newline  2 = unwahrscheinlich\newline 3 = gelegentlich\newline 4 = sehr wahrscheinlich\newline 5 = häufig\\
  \end{tabulary}
\end{table}
...
\begin{table}[H]
  ...
  \begin{tabulary}{1.0\textwidth}{|C|L|L|C|C|C|}
    ...
    \hline
    5 &  Die gesetzten Ziele können nicht erreicht werden & Organisatorisch & 2  & 4 & \cellcolor[HTML]{FFC000}8\\
    \hline
    6 & Es werden falsche Anforderungen umgesetzt & Projektmanagement & 2 & 3 & \cellcolor[HTML]{92D050}6\\
    \hline
    7 & Das abspeichern / hinzufügen von Daten dauert zu lange & Technisch & 2 & 2 & \cellcolor[HTML]{00B050}4\\
    \hline
...
\input{content/main/funktionaleAnforderungen.tex}
...
\begin{table}[ht]
  ...
  \label{NFA-Sicherheit}
\end{table}

\subsection{Lösungsvarianten}
Als Lösungsvarianten für die Applikation werden verschiedene Technologien in Betracht gezogen.
\begin{itemize}
  \item Webbasierte Applikation mit SQL Datenbank in der Cloud
  \item Applikation mit WPF und .NET, als Datenbankschnittstelle Entity Framework
  \item Applikation Windows Forms und .net Framework, als Datenbankschnittstelle Entity Framework
\end{itemize}

Da die Applikation in Verschiedenen Standorten genutzt werden soll und unter Umständen auch von den Hauswartungspersonen zum Erfassen von Reparaturanträgen oder sonstigen Einträgen verwendet werden soll, würde sich eine Webbasierte Applikation bestens eignen.\\
Da im Rahmen der Semesterarbeit aber nur ein Prototyp mit einer schon bekannten Technologie erstellt werden soll, kommt diese Lösung nicht infrage. Stattdessen wird als Lösung die Variante mit WPF und .NET gewählt, da in einer früheren Projektarbeit schon erfolgreich ein Projekt mit dieser Technologie umgesetzt wurde.