...
\begin{table}[H]
  ...
  \setlength\extrarowheight{2pt}
    ...
    \hline 
    \textbf{Income} & Bildet alle Einnahmen in einem Konto ab.\\
    \hline
    \textbf{Expense} & Bildet alle Ausgaben in einem Konto ab.\\
    \hline
...
\begin{table}[H]
  ...
  \setlength\extrarowheight{2pt}
    ...
    \hline
    \textbf{Income} & Bildet alle Einnahmen zu einem Konto ab\\
    \hline
    \textbf{Expense} & Bildet alle Ausgaben zu einem Konto ab\\
    \hline
...
Über die Kreditoren können die Rechnungen  zum angewählten Kreditor angesehen oder neu erstellt werden und es kann ein Kreditor neu erstellt oder editiert werden.\\ 
Über den Mieter können die vom Mieter gemieteten Objekte bzw. die zum Mieter gehörenden Mietverträge und seine Rechnungen angesehen werden. Es kann auch ein neuer Mieter erstellt, oder ein bestehender bearbeitet werden.\\
