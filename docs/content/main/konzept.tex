...
\begin{figure}[H]
  \begin{center}
    \includegraphics[height=0.6\textwidth]{content/diagrams/out/guiMap/GuiMindMAp.png}
    \caption{GUI Flowmap}
    \label{guiFlowMap}
  \end{center}
\end{figure}
...
Über den Mieter können die vom Mieter gemieteten Objekte, seine Rechnungen und die Mietverträge angesehen, bzw. bearbeitet werden.\\
Wie im Geschäftsanwendungsfall \ref{GA-rechnungErstellen} ''Rechnung Erstellen'' beschrieben, kann eine schon freigegebene Rechnung nicht mehr verändert werden.