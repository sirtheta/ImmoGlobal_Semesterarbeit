...
\begin{table}[H]
  \centering
  \settowidth\tymin{\textbf{Version}}
  \setlength\extrarowheight{2pt}
    \begin{tabulary}{1.0\textwidth}{|m{5cm}|C|L|}
      \hline
      \rowcolor[HTML]{4473C5}\textbf{Paket} & \textbf{Version} & \textbf{Beschreibung}\\
    \hline
    \textbf{FontAwesome6. Svg} & 1.1.0 & SVG-Icon Bibliothek, wird für die Icons in der MenuBar verwendet.\\
    \hline
...
Hier werden als Testprotokoll alle in Kapitel \ref{testfaelle} definierten Testfälle mit ihrem Soll-Ergebnis dargestellt.
